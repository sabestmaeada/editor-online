...
## รูปแบบภาพประกอบ (Image Placeholder)
- Syntax: \`[[IMAGE: คำอธิบายภาษาไทย | prompt_en: English description for AI generator]]\`
...
## รูปแบบตาราง (Table)
- ใช้ Markdown table syntax — header row + data rows อยู่ในตารางเดียวกัน
